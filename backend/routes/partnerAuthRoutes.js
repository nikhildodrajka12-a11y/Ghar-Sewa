...
const PartnerAuth = require("../models/PartnerAuth");
...
const emailRegex = /^[a-zA-Z0-9._%+-]+@(gmail\.com|[a-zA-Z0-9.-]+\.ac\.in)$/;
    ...
    const userExists = await PartnerAuth.findOne({ username });
...
router.post("/login", async (req, res) => {
  try {
    ...
    const user = await PartnerAuth.findOne({ username });
